    ...
    <div class="price_plans">
      <div class="plan essentials one-third column">
        ...
        <ul>
          ...
          <li><i class="fa-solid fa-check green"></i> Monthly WordPress + Plugin updates</li>
      ...
      <div class="plan premium one-third column">
        ...
        <ul>
          <li class="heading"><strong>Support & updates</strong></li>
          <li><i class="fa-solid fa-check green"></i> Up to 4 hours support each month</li>
          <li><i class="fa-solid fa-check green"></i> Daily backups</li>
          <li><i class="fa-solid fa-check green"></i> Weekly WordPress + Plugin updates</li>
          <li class="heading"><strong>Website reviews</strong></li>
          <li><i class="fa-solid fa-check green"></i> Weekly performance review</li>
          <li><i class="fa-solid fa-check green"></i> Weekly security review</li>
          <li class="heading"><strong>Website monitoring</strong></li>
          <li><i class="fa-solid fa-check green"></i> Daily security updates</li>
          <li><i class="fa-solid fa-check green"></i> Uptime monitoring (60 second interval)</li>
          <li><i class="fa-solid fa-check green"></i> SSL Monitoring</li>
          <li><i class="fa-solid fa-check green"></i> Domain Monitoring</li>
          <li><i class="fa-solid fa-xmark green"></i> 404 Monitoring</li>
          <li class="heading"><strong>WordPress email</strong></li>
          <li><i class="fa-solid fa-check green"></i> SMTP for improved email deliverability</li>
